    ...
    if (jQuery('.swiper-slider-timeline').length > 0) {
        jQuery('.swiper-slider-timeline').each(function (index, element) {
            if (window.innerWidth > 767) {
                ...
                $navigation  = jQuery('<div class="swiper-pagination-navigation-style-2 swiper-pagination-navigation-style-2--static"> <div class="swiper-button-prev"></div> <div class="swiper-pagination"></div> <div class="swiper-button-next"></div> </div>');
            }
