...
?>
    ...
    <div class="offcanvas offcanvas--layouts offcanvas-start show" tabindex="-1" id="offCanvas360-<?= $post_id ?>" aria-labelledby="offCanvas360-<?= $post_id ?>Label" aria-modal="true" role="dialog">
