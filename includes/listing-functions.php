...
?>
    <div class="listing--buttons mt-2">
        <ul class="d-flex gap-3 m-0 fs-15 p-0 w-100 justify-content-between align-items-center list-inline">
            <?php if ($_360_walkthrough) { ?>
                <li>
                    <button class="py-2 px-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offCanvasLayout" aria-controls="offCanvas360-<?= $post_id ?>">
                        360° Walkthrough
                    </button>
                </li>
            <?php } ?>
            <?php if ($video) { ?>
                <li>
                    <button class="py-2 px-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offCanvasLayout" aria-controls="offCanvasVideo-<?= $post_id ?>">
                        Video Tour
                    </button>
                </li>
            <?php } ?>
    ...
    <div class="offcanvas offcanvas--layouts offcanvas-start" tabindex="-1" id="offCanvas360-<?= $post_id ?>" aria-labelledby="offCanvas360-<?= $post_id ?>Label" aria-modal="true" role="dialog">
